...
class MainWin {
    ...
    BuildAndShow() {
        ...
        tbInner := tb.Add("Grid")
        tbInner.Add("TextBlock").Text(title).Foreground("{DynamicResource TitleBarForeground}").FontSize(14).FontWeight("SemiBold").VerticalAlignment("Center").Margin("15,0,0,0")
        btnGroup := tbInner.Add("StackPanel").Orientation("Horizontal").HorizontalAlignment("Right")
        minBtn := btnGroup.Add("Button").Name("BtnMinimize").WindowChrome_IsHitTestVisibleInChrome("True").Width(40).Background("Transparent").Foreground("{DynamicResource TitleBarForeground}").BorderThickness(0)
        ...
        maxBtn := btnGroup.Add("Button").Name("BtnMaximize").WindowChrome_IsHitTestVisibleInChrome("True").Width(40).Background("Transparent").Foreground("{DynamicResource TitleBarForeground}").BorderThickness(0)
    ...
    BuildToolTab() {
        ...
        Add(this._LabelRow("文本识别模型：", '<ComboBox Name="CmbOCRType" Width="100" Height="26" MinHeight="26" VerticalContentAlignment="Center" FontSize="11" Foreground="{DynamicResource InputText}" Background="{DynamicResource InputBg}" BorderBrush="{DynamicResource InputStroke}" BorderThickness="1" SelectedIndex="' (MainSoftData.OCRTypeValue - 1) '"><ComboBoxItem Content="' GetLang("中文") '"/><ComboBoxItem Content="' GetLang("英文") '"/></ComboBox>'))
        ...
        UIControls.OCRType := CtrlAdapter("CmbOCRType", this.ui, "SelectedIndex")
    ...
    BuildSettingTab() {
        ...
        Add('<WrapPanel ' ns ' Orientation="Horizontal">'
            ...
            . this._ComboRow(GetLang("手柄类型："), "CmbJoyType", ["Xbox", "PS5"], MainSoftData.JoyType)
    ...
    _ComboRow(label, name, items, sel, tip := "") {
        ...
        return '<StackPanel ' ns ' Orientation="Horizontal" Margin="0,4,16,4"' tipAttr '>'
            ...
            . '<ComboBox Name="' name '" Width="130" Height="26" MinHeight="26" VerticalContentAlignment="Center" FontSize="11" Foreground="{DynamicResource InputText}" Background="{DynamicResource InputBg}" BorderBrush="{DynamicResource InputStroke}" BorderThickness="1"' selAttr '>' itemsXaml '</ComboBox>'
            . '</StackPanel>'
    }
    ...
    BuildHelpTab() {
        ...
        Add(this._LinkRow(GetLang("更新视频合集："), "https://www.bilibili.com/video/BV1oWVRzaEzk", GetLang("版本更新视频，直播交流问答")))
